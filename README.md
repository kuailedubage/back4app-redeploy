...
> **Note:** No PAT required. The workflow uses the built-in `GITHUB_TOKEN` (with `variables: write` permission) to manage the cooldown variable.

### 3. Enable Workflow Permissions

Go to **Settings > Actions > General > Workflow permissions**, select **Read and write permissions**, and save.
